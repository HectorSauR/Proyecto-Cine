...
public class Almacen {
	...
	private void initialize() {
		...
		JButton btn_individual = new JButton("Deshabilitar");
		btn_individual.setForeground(Color.WHITE);
		...
		btn_individual.setBounds(496, 429, 101, 46);
		...
		JButton btn_clientes_4 = new JButton("Administrador");
		btn_clientes_4.setForeground(Color.WHITE);
		btn_clientes_4.setFont(new Font("Arial", Font.PLAIN, 12));
		btn_clientes_4.setBorder(null);
		btn_clientes_4.setBackground(new Color(40, 75, 99));
		btn_clientes_4.setBounds(599, 0, 100, 38);
		frmCinema.getContentPane().add(btn_clientes_4);
